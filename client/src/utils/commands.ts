...
const commands: Commands = [
  ...
  },
  {
    ...
    value: 'Call',
    description:
      'Make a raw API call and to get a raw API response (Experimental)',
  },
  {
  ...
  },
  {
    ...
    longDescription:
      'Create a group channel invite code, other nodes can join the group using join-group-channel',
    flags: {
  ...
  },
  {
    ...
    value: 'Decrypt',
    description:
      'Decrypt a message encrypted to the node key or to another node key.',
    args: {
      encrypted: 'Encrypted',
    },
  },
  ...
  },
  {
    ...
    value: 'Forwards',
    description:
      'Peers where routing has taken place from inbound and outbound sides',
    longDescription:
  ...
  },
  {
    ...
    longDescription:
      'Another node should have run create-group-channel to create group',
    args: {
      code: 'Code',
    },
    flags: {
  ...
  },
  {
    ...
    description:
      'Send funds to a node off-chain via keysend or lnurl/lightning address',
    longDescription:
